...
Prerequisites:
1. Compatible device (router, single-board computer, or virtual machine)
2. Ethernet cable
3. Computer with a web browser and terminal access
4. USB drive (for backup and installation media)
...
2. For single-board computers and virtual machines:
